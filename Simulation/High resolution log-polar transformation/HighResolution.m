...
Wavelength = 405*nm; 
%%
E1 = 1*GenerateLGLightZheng(2, 0, 1.5*mm, var.rho, var.theta);
E2 = 0*GenerateLGLightZheng(1, 0, 1.5*mm, var.rho, var.theta);
E3 = 1*GenerateLGLightZheng(0, 0, 1.5*mm, var.rho, var.theta);
...
DrawEIntenAndAngle(resize(fftshift(Field), 400),2)
